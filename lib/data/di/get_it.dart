...
Future init() async {
  ...
  getItInstance.registerLazySingleton<NotificationServices>(() => NotificationServices());

  getItInstance.registerLazySingleton<ContactDataSource>(() => ContactDataSourceImpl(getItInstance()));
  ...
  getItInstance.registerLazySingleton<NotificationRemoteDataSource>(() => NotificationRemoteDataSourceImpl(getItInstance()));

  getItInstance.registerLazySingleton<NotificationRepository>(() => NotificationRepository(getItInstance()));
}
