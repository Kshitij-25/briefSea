...
class AuthRepository {
  ...
  Future<Either<AppError, bool?>> isUserRegistered(String? email, String? appleToken) async {
    try {
      final isUserRegistered = await _authRemoteDataSource.isUserRegistered(email, appleToken);
      return Right(isUserRegistered!);
    } on AppError catch (e) {
      return Left(e);
    } on Exception catch (e) {
