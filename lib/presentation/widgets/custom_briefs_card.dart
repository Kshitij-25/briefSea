            ...
            children: [
              Row(
                children: [
                  GestureDetector(
                    onTap: () {
                      if (isUserTrue != true && brief!.userId != null) {
                        context.push(
              ...
              Row(
                ...
                children: [
                  _BriefLikeButton(
                    ...
                    iconLabel: (brief?.likesCount != null)
                        ? (brief!.likesCount! < 1
                            ? 'Like'
                            : brief!.likesCount == 1
                                ? '${brief!.likesCount} Like'
                                : "${brief!.likesCount} Likes")
                        : '-',
                    onPressed: () => onLikeTap(brief),
                  ),
                  _BriefInputButton(
                    iconData: CupertinoIcons.chat_bubble,
                    iconLabel: (brief?.replyCount != null)
                        ? (brief!.replyCount! < 1
                            ? 'Comment'
                            : brief!.replyCount! == 1
                                ? '${brief!.replyCount} Comment'
                                : "${brief!.replyCount} Comments")
                        : '-',
...
class NetworkAvatarWidget extends ConsumerWidget {
  ...
  Future<BriefsResult?> _initializeImageProviders(WidgetRef ref, BriefsResult briefModel) async {
    try {
      if (briefModel.avatarSrc != null && briefModel.avatarSrc != '' && !briefModel.avatarSrc!.contains('https')) {
