...
class _AllBriefsScreenState extends ConsumerState<AllBriefsScreen> {
  ...
  Future<String?> _postLike(String threadId, Map<String, String> userDetails) async {
  ...
  Future<void> _sendLikeNotification(BriefsResult brief, String? likeId) async {
