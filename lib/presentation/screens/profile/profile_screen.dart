...
class ProfileScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final testimonialName = useTextEditingController();
    final testimonailProfileUrl = useTextEditingController();
    final testimonailText = useTextEditingController();

    final companyName = useTextEditingController();
    final companyStartDate = useTextEditingController();
    final companyEndDate = useTextEditingController();

    final clientName = useTextEditingController();
    final startDate = useTextEditingController();
    final endDate = useTextEditingController();
    final clientPortfolio = useTextEditingController();
                        ...
                        if ((userDetails.testimonials?.isEmpty == true && isOtherProfile != true) || (userDetails.testimonials?.isNotEmpty == true))
                          CompanyCard(
                            ...
                            companyOnPressed: () async {
                              ...
                              if (profileEdited.acknowledged == true) {
                                ref.invalidate(UserProfileProvider.getUserProfileProvider);
                                AppUtility(context).message('Company Added');
                                GoRouter.of(context).pop();
                              }
                            },
                          ),
