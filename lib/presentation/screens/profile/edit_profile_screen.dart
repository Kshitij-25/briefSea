              ...
              onPressed: () async {
                if (_formKey.currentState!.validate()) {
                  ...
                  var fullProfileData = {
                    ...
                    'postingAs': selectedAccountType ?? widget.userProfileModel.postingAs,
                    ...
                    'gender': selectedGender ?? widget.userProfileModel.gender,
                        ...
                        children: [
                          ...
                          DropdownButtonFormField<String>(
                            ...
                            value: ref.watch(selectAccountTypeProvider).selectedType ??
                                "${widget.userProfileModel.postingAs?[0].toUpperCase()}${widget.userProfileModel.postingAs!.substring(1)}",
