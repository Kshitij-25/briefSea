...
import '../terms_and_privacy/terms_and_privacy_view.dart';
                ...
                child: SizedBox(
                  ...
                  child: SafeArea(
                    child: Column(
                      ...
                      children: [
                        SizedBox(
                          height: getDeviceType(context) == DeviceType.Tablet ? ScreenSize.height(context) * .4 : ScreenSize.height(context) * .3,
                          child: logoImage!,
                        ),
                            ...
                            builder: (context, ref, _) {
                              return Container(
                                ...
                                child: SignInWithAppleButton(
                                  ...
                                  onPressed: () async {
                                    await ref.read(loginNotifierProvider.notifier).loginWithApple(
                                          context: context,
                                          ref: ref,
                                          isLogin: true,
                                        );
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              SizedBox(width: ScreenSize.width(context) * .01),
              Text(
